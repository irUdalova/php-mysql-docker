...
class ProfileEditPageController {
  ...
  public function canHandle() {
    ...
    if ($isMethodSupported && $_SERVER["REQUEST_URI"] === '/profile/edit') {
      return true;
    }
    return false;
  }
  ...
  public function handle() {
    ...
    if ($_SERVER["REQUEST_METHOD"] === "POST") {
      ...
      if (empty($isErrors)) {
        ...
        $user = new UsersModel;
        $userBio = $postData['bio'] ?? NULL;

        $isUpdate = $user->update($postData['name'], $postData['bio'], $params['userID']);
        ...
        // $params['userData']['bio'] = $postData['bio'];
      }
      echo $this->renderView('profileEdit', $params);
    }
  }
