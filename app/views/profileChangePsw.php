...
<div class="profile-wrap">
  ...
  <div class="user-content">
    ...
    <form class="edit-profile-form" action="/profile/change-password" method="post" novalidate>
      ...
      <label for="bio">Confirm new password
      ...
      <div class="choose-submit">
        <button class="sbm-btn update" type="submit" name="update">Change</button>
